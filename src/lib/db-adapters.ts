...
export function dbTenantToUi(t: DbTenant): Tenant {
  return {
    ...
    address: t.address ?? "",
    cep: t.cep ?? null,
    addressNumber: t.address_number ?? null,
    addressReference: t.address_reference ?? null,
    ...
    deliveryMode: (t.delivery_mode ?? "single") as "none" | "single" | "neighborhood" | "km",
    ...
    deliveryFeePerKm: t.delivery_fee_per_km != null ? Number(t.delivery_fee_per_km) : null,
    deliveryMaxKm: t.delivery_max_km != null ? Number(t.delivery_max_km) : null,
    hours: t.hours ?? "",
