  ...
  public: {
    Tables: {
      ...
      directory_clicks: {
        ...
        Relationships: [
          {
            foreignKeyName: "directory_clicks_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "directory_public"
          ...
          {
            foreignKeyName: "directory_clicks_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "directory_public"
            referencedColumns: ["tenant_id"]
      ...
      push_campaigns: {
        ...
        Relationships: [
          {
            foreignKeyName: "push_campaigns_coupon_id_fkey"
            columns: ["coupon_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "push_campaigns_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "directory_public"
            referencedColumns: ["tenant_id"]
