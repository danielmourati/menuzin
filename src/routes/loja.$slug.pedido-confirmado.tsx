...
function ConfirmedPage() {
  ...
  // Busca inicial pelo número (rápido — funciona em SSR e refresh)
  ...
  // Assina realtime pelo UUID assim que sabemos qual é o id
      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="text-center">
          ...
          <Button asChild className="mt-4">
            <Link to="/loja/$slug" params={{ slug }}>Voltar ao catálogo</Link>
          </Button>
        </div>
      </div>
    );
        ...
        <div className="rounded-3xl border bg-card p-6 text-center shadow-[var(--shadow-soft)]">
          ...
          <div className="mt-6 space-y-2">
            ...
            <Button asChild variant="outline" className="h-12 w-full">
              <Link
                to="/loja/$slug/acompanhar/$orderId"
